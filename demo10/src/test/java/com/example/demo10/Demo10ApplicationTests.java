...
//    }
    ...
    void showAll(){
        ...
        studentQueryWrapper.gt("age",20);//查询年龄大于20
        List<Student> students = stuMapper.selectList(studentQueryWrapper);
        for(Student student:students){
            System.out.println("student = " + student);
        }
    }
    ...
    void change(){
        ...
        updateWrapper.eq("id",207);
        stuMapper.update(student,updateWrapper);
    }
    @Test
    public void autoGenerate() {
        ...
        // 填写代码生成的目录(需要修改)
        String projectPath = "D:\\桌面\\Web后台作业\\demo10";
        // 拼接出代码最终输出的目录
        ...
        // 配置数据库 url 地址
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/student?serverTimezone=UTC");
        ...
        // 配置数据库连接密码
        dsc.setPassword("Wmy230404");
        mpg.setDataSource(dsc);

        // Step:4：包配置
        PackageConfig pc = new PackageConfig();
        // 配置父包名（需要修改）
        pc.setParent("com.example.demo10");
        // 配置模块名（需要修改）
        pc.setModuleName("");
        // 配置 entity 包名
        pc.setEntity("model");
